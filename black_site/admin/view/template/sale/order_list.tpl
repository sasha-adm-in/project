        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="right">
                <a href="javascript:;">Итого со скидкой</a>
              </td>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td align="right"><input type="text" size="4" style="text-align: right;" /></td>
            ...
            <tr>
              ...
              <td class="right"><?php echo $order['total_with_discount']; ?></td>
