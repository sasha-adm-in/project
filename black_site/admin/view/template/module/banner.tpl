          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><input type="text" name="banner_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
                ...
                <?php } ?></td>
              <td class="left">
                <select name="banner_module[<?php echo $module_row; ?>][layout_id]" class="layout">
                ...
                <div class="category_info" style="display: <?php echo $module['layout_id'] == 3 ? 'block' : 'none'; ?>;">
                    <input style="width: 90%;" type="text" value="<?php echo ($module['layout_id'] == 1) ? 'main' : $module['category_name']; ?>" placeholder="Введите название категории" name="banner_module[<?php echo $module_row; ?>][category_name]" />
                    <input type="hidden" value="<?php echo ($module['layout_id'] == 1) ? 'main' : $module['category_id']; ?>" name="banner_module[<?php echo $module_row; ?>][category_id]" />     
                </div>
              </td>
...
function addModule() {	
	...
	html += '    <td class="left"><select name="banner_module[' + module_row + '][layout_id]" class="layout">';
	<?php foreach ($layouts as $layout) { ?>
	html += '      <option value="<?php echo $layout['layout_id']; ?>"><?php echo addslashes($layout['name']); ?></option>';
	<?php } ?>
	html += '    </select> \
                    <div class="category_info" style="display: none;"> \
                        <input style="width: 90%;" type="text" placeholder="Введите название категории" name="banner_module[' + module_row + '][category_name]" /> \
                        <input type="hidden" name="banner_module[' + module_row + '][category_id]" /> \
                    </div> \
                 </td>';
