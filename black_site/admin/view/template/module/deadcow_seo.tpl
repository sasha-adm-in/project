        ...
        <div class="content">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <table class="form">
                    ...
                    <tr>
                        <td><?php echo $transliteration; ?></td>
                        <td colspan="2">
                            <input type="hidden" name="do_transliteration" value="0">
                            <label><input type="checkbox" name="do_transliteration"<?php if ($do_transliteration == 1) echo ' checked="checked"'; ?> value="1"><?php echo $transliteration_detail; ?></label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <br/><?php if (in_array('curl', get_loaded_extensions())) { ?>
                                <label><input type="checkbox" name="yahoo_checkbox"<?php if ($yahoo_checkbox == 1) echo ' checked="checked"'; ?>><?php echo $add_from_yahoo; ?></label>
                                <br/>
