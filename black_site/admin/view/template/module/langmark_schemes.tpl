...
function delayer(){
    window.location = 'index.php?route=module/langmark/schemes&token=<?php echo $token; ?>';
}
</script>
       ...
       <td style="width: 200px;"><?php echo $this->language->get('text_action'); ?></td>
        ...
        ?>
          ...
          <tr id="module-row<?php echo $module_row; ?>">
            ...
            <!--
            <select name="langmark_module[<?php echo $module_row; ?>][layout_id]">
				...
				<div class="scrollbox" style="width: auto; height: 100px;">
                  ...
                  <div class="<?php echo $class; ?>">
                    ...
                    <input type="checkbox" name="langmark_module[<?php echo $module_row; ?>][layout_id][]" value="<?php echo $layout['layout_id']; ?>" checked="checked" />
                    <?php echo $layout['name']; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="langmark_module[<?php echo $module_row; ?>][layout_id][]" value="<?php echo $layout['layout_id']; ?>" />
                    <?php echo $layout['name']; ?>
                    <?php } ?>
                  </div>
                  <?php } ?>
            ...
            <td class="left"><select name="langmark_module[<?php echo $module_row; ?>][position]">
            ...
            <td class="left"><select name="langmark_module[<?php echo $module_row; ?>][status]">
              ...
              <td class="left">
               <select name="langmark_module[<?php echo $module_row; ?>][what]">
           	<?php
				if (is_array($general_list) && count($general_list)>0)
				{
  ...
  <!--
      ...
      -->
            ...
            <td class="right"><input type="text" name="langmark_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
            <td class="left">
            <?php if (isset($module['what']) && $module['what']=='what_hook' ) {
...
function addModule() {	var aindex = -1;
   ...
   html += '               <input type="checkbox" name="langmark_module[' + module_row + '][layout_id][]" value="<?php echo $layout['layout_id']; ?>" />';
   ...
   html += '             <a onclick="$(this).parent().find(\':checkbox\').attr(\'checked\', true);"><?php echo $this->language->get('text_select_all'); ?></a> / <a onclick="$(this).parent().find(\':checkbox\').attr(\'checked\', false);"><?php echo $this->language->get('text_unselect_all'); ?></a></td>';
	...
	html += '    </td>';
	html += '    <td class="left"><select name="langmark_module[' + module_row + '][position]">';
	html += '      <option value="content_top"><?php echo $text_content_top; ?></option>';
	html += '      <option value="content_bottom"><?php echo $text_content_bottom; ?></option>';
	html += '      <option value="column_left"><?php echo $text_column_left; ?></option>';
	html += '      <option value="column_right"><?php echo $text_column_right; ?></option>';
	html += '    </select></td>';
	html += '    <td class="left"><select name="langmark_module[' + module_row + '][status]">';
    html += '      <option value="1" selected="selected"><?php echo $text_enabled; ?></option>';
    html += '      <option value="0"><?php echo $text_disabled; ?></option>';
    html += '    </select></td>';


	html += '    <td class="left"><select name="langmark_module[' + module_row + '][what]">';
	...
	html += '    <td class="right"><input type="text" name="langmark_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
