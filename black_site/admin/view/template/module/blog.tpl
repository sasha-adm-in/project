...
function delayer(){
 ...
 <div id="tabs" class="htabs"><a href="#tab-options"><?php echo $this->language->get('tab_options'); ?></a><a href="#tab-install"><?php echo $this->language->get('entry_install_update'); ?></a></div>
