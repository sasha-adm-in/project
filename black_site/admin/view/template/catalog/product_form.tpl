        ...
        <div id="tab-data">
          <table class="form">
            <tr>
              ...
              <tr>
                  <td><span class="required">*</span> Единица измерения</td>
          ...
          <table id="special" class="list">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <td class="left"><input type="text" name="product_special[<?php echo $special_row; ?>][date_end]" value="<?php echo $product_special['date_end']; ?>" class="datetime_special" /></td>
...
function addSpecial() {
	...
	html += '    <td class="left"><input type="text" name="product_special[' + special_row + '][date_end]" value="" class="datetime_special" /></td>';
...
$('.time').timepicker({timeFormat: 'h:m'});
		...
		//3274//
		$('.datetime_special').datetimepicker({
			dateFormat: 'yy-mm-dd',
			timeFormat: 'h:m:s',
			hour: 12,
			minute: 00
