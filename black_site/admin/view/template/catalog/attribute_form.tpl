        ...
        <table class="form">
          ...
          <tr>
            ...
            <tr>
                ...
                <td>
                    <?php foreach ($languages as $language) { ?>
                        <textarea name="attribute_description[<?php echo $language['language_id']; ?>][description]" cols="100" rows="5"><?php echo isset($attribute_description[$language['language_id']]) ? $attribute_description[$language['language_id']]['description'] : ''; ?></textarea>
