        ...
        <div id="tab-data">
          <table class="form">
            <tr>
              ...
              <td><input type="text" id="record_seo_url" name="keyword" value="<?php echo $keyword; ?>" /></td>
            </tr>
            <tr>
...
} else {$('#product-related div img').live('click',  function() {
	$(this).parent().remove();
...
if (c) {    $('#blog_main_'+v).removeAttr("disabled");
} else {	$('#blog_main_'+v).attr("disabled", "disabled");
