...
$_['entry_sms_alert']          = 'Включить SMS уведомления для администратора:';
$_['entry_sms_alert_client']   = 'Включить SMS уведомления для клиентов:';
...
$_['error_address']                = 'Адрес магазина должен быть от 3 до 2000 символов!';
