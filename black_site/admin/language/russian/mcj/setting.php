...
$_['text_kb']             			= 'Кб';
$_['text_post_processing']          = 'Постобработка';
...
$_['tab_js']					   					= 'JavaScript';
	...
	$_['text_js_cut_scripts']                 		= 'Переместить inline скрипты вместе с остальными:';
	$_['text_js_paste_position']                 	= 'Вставлять все скрипты перед: <br><span class="help">В формате регулярного выражения. (preg_match)</span>';
