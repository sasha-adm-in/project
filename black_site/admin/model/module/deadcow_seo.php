...
{
    public function generateCategories($template, $suffix, $source_langcode = null, $overwrite = true, $transliterate = true)
    {
    ...
    public function generateProducts($template, $suffix, $source_langcode = null, $overwrite = true, $transliterate = true)
    {
    ...
    public function generateManufacturers($template, $suffix, $source_langcode = null, $overwrite = true, $transliterate = true)
    {
    ...
    public function generateProductsMetaKeywords($template, $yahooID = null, $source_langcode = null, $transliterate = true)
    {
