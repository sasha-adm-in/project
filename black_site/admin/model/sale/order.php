...
class ModelSaleOrder extends Model {
	...
	public function editOrder($order_id, $data) {
        ...
        $order_statuses = $this->db->query("SELECT name FROM `" . DB_PREFIX . "order_status` WHERE order_status_id = '" . (int)$data['order_status_id'] . "'");
        
        if ($order_query->row['order_status_id'] != $data['order_status_id'] && $this->config->get('config_sms_alert_client')) {
            $this->smsfly->sendToClientStatus($order_query->row['telephone'], $order_id, $order_statuses->row['name']);
        } 
	}
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, o.total_with_discount, CONCAT(o.firstname, ' ', o.lastname) AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS status, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified FROM `" . DB_PREFIX . "order` o";
