	...
	public function index() {
		...
		*/
		...
		if (isset($this->request->post['yandex_yml_pricefrom'])) {
			...
			$this->data['pricefrom'] = $this->config->get('yandex_yml_pricefrom');
		}
		...
		if (isset($this->request->post['yandex_yml_attr_vs_description'])) {
			...
			$this->data['yandex_yml_attr_vs_description'] = $this->config->get('yandex_yml_attr_vs_description');
		}
		...
		if (isset($this->request->post['yandex_yml_product_rel'])) {
			...
			$this->data['yandex_yml_product_rel'] = $this->config->get('yandex_yml_product_rel');
		}
		if (isset($this->request->post['yandex_yml_product_accessory'])) {
			...
			$this->data['yandex_yml_product_accessory'] = $this->config->get('yandex_yml_product_accessory');
		}
