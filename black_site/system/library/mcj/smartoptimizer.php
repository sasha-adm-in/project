...
$settings = array(
	...
	'gzip' => true,
	'compressionLevel' => 9,
	'gzipExceptions' => array('gif','jpeg','jpg','png','swf','ico', 'cssgz', 'jsgz'),
	'minify' => false,
	'concatenate' => false,
	'separator' => ',',
	'embed' => true,
...
if ($settings['gzip'] || in_array($fileType, $gzippedTypes)) header("Content-Encoding: gzip");
...
header('Etag: "' . md5($mtimestr.json_encode($files)) . '"');
