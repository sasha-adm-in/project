...
$this->data['text_mcj'] = $this->language->get('text_mcj');
...
$this->data['exchange1c'] = $this->url->link('module/exchange1c', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['discounts'] = $this->url->link('catalog/discounts', 'token=' . $this->session->data['token'], 'SSL');
...
$this->data['mcj'] = $this->url->link('mcj/setting', 'token=' . $this->session->data['token'], 'SSL');
