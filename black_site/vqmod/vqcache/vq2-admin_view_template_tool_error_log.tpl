...
<div class="buttons"><a href="<?php echo $clearcache; ?>" class="button"><?php echo $button_clearcache; ?></a></div><div class="buttons"><a href="<?php echo $clearimagecache; ?>" class="button">Clear Image Cache</a></div>
    </div>
    <div class="content">
