...
$_['text_login']             = 'Необходимо <a href="%s">Войти в Личный кабинет</a> или <a href="%s">создать аккаунт</a> для просмотра цен!';
$_['text_points']            = 'Бонусные баллы: %s';
$_['text_items']             = '<a href="/index.php?route=checkout/simplecheckout">Товаров: %s </a> - %s';
$_['text_next']              = 'Воспользуйтесь дополнительными возможностями';
$_['text_next_choice']       = 'Если у вас есть код купона на скидку или бонусные баллы, которые вы хотите использовать, выберите соответствующий пункт. Также можно примерно узнать стоимость доставки в ваш регион.';
...
$_['text_shipping_detail']   = 'Укажите ваш регион для оценки стоимости доставки.';
$_['text_shipping_method']   = 'Выберите удобный способ доставки этого заказа.';
$_['text_empty']             = 'В корзине!';
...
// Error
$_['error_stock']            = 'Отмеченные товары ***, недоступны в нужном количестве или отсутствуют на складе!';
$_['error_minimum']          = 'Минимальное количество для заказа товара %s составляет %s!';
$_['error_required']         = 'Поле %s должно быть заполнено!';	
$_['error_product']          = 'В корзине!';	
$_['error_coupon']           = 'Ошибка: купон или недействителен, или истек срок его действия, или достигнут предел его использования!';
