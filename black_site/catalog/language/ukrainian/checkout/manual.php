...
$_['error_permission']  = 'У вас нет прав для доступа к этой странице, обратитесь к администратору.';
$_['error_customer']    = 'Невозможно найти избранное покупателя!';
...
$_['error_voucher']     = 'Неверно указан код подарочные сертификаты, или он уже использован, или истек срок действия!';
