...
class ControllerAccountOrder extends Controller {
	...
	public function index() {
		...
		$this->data['text_mycabinet_totals'] = $this->language->get('text_mycabinet_totals');
		...
		foreach ($results as $result) {
			...
			$this->data['orders'][] = array(
                ...
                'total_with_discount'      => $this->currency->format($result['total_with_discount'], $result['currency_code'], $result['currency_value']),
	...
	public function info() { 
		...
		//add-----------------------
            ...
            $this->data['total_with_discount'] = $this->currency->format($order_info['total_with_discount'], $order_info['currency_code'], $order_info['currency_value']);
