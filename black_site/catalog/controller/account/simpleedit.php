...
class ControllerAccountSimpleEdit extends Controller {
    ...
    public function index() {
		...
		$this->data['text_simped_options'] = $this->language->get('text_simped_options');
		$this->data['text_simped_zakaz'] = $this->language->get('text_simped_zakaz');
		$this->data['text_simped_pidpr'] = $this->language->get('text_simped_pidpr');
		$this->data['text_simped_exit'] = $this->language->get('text_simped_exit');
		$this->data['text_simped_save'] = $this->language->get('text_simped_save');
