...
class ControllerAccountPassword extends Controller {
	private $error = array();
  	...
  	public function index() {	
		...
		$this->data['text_pas_options'] = $this->language->get('text_pas_options');
		$this->data['text_pas_zakaz'] = $this->language->get('text_pas_zakaz');
		$this->data['text_pas_pidpr'] = $this->language->get('text_pas_pidpr');
		$this->data['text_pas_exit'] = $this->language->get('text_pas_exit');
		$this->data['text_pas_save'] = $this->language->get('text_pas_save');
		$this->data['text_pas_passw'] = $this->language->get('text_pas_passw');
		$this->data['text_pas_confirm'] = $this->language->get('text_pas_confirm');
