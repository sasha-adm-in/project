...
class ControllerAccountSimpleAddress extends Controller {
    ...
    public function insert() {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->data['simple_edit_address'] && $this->validate()) {
            $data = array(
                ...
                'default'    => !empty($this->request->post['default']) ? true : false
            );
    ...
    public function update() {
		...
		$this->data['text_simpad_options'] = $this->language->get('text_simpad_options');
		$this->data['text_simpad_zakaz'] = $this->language->get('text_simpad_zakaz');
		$this->data['text_simpad_pidpr'] = $this->language->get('text_simpad_pidpr');
		$this->data['text_simpad_exit'] = $this->language->get('text_simpad_exit');
		$this->data['text_simpad_save'] = $this->language->get('text_simpad_save');
