...
class ControllerCheckoutSimpleCheckout extends Controller { 
    public function index() {
        ...
        if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
            ...
            if (isset($this->session->data['delivery_region'])) {
                unset($this->session->data['delivery_region']);
            }
            
            if (isset($this->session->data['delivery_city'])) {
                unset($this->session->data['delivery_city']);
            }
            
            if (isset($this->session->data['delivery_warenhouse'])) {
                unset($this->session->data['delivery_warenhouse']);
            }
            
            if (isset($this->session->data['delivery_payment'])) {
                unset($this->session->data['delivery_payment']);
            }

            if (isset($this->session->data['redelivery'])) {
                unset($this->session->data['redelivery']);
            }
