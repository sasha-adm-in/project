...
class ControllerCheckoutSimpleCheckoutCustomer extends Controller {
    ...
    public function index() {
		...
		$this->data['main_firstname'] = $this->language->get('main_firstname');
		$this->data['main_telephone'] = $this->language->get('main_telephone');
		$this->data['main_city'] = $this->language->get('main_city');
		$this->data['main_email'] = $this->language->get('main_email');
		$this->data['main_comment'] = $this->language->get('main_comment');

		$this->data['text_cart_contactd'] = $this->language->get('text_cart_contactd');
		$this->data['text_cart_newp'] = $this->language->get('text_cart_newp');
		$this->data['text_cart_dcpok'] = $this->language->get('text_cart_dcpok');
		$this->data['text_cart_fizl'] = $this->language->get('text_cart_fizl');
		$this->data['text_cart_url'] = $this->language->get('text_cart_url');
		$this->data['text_cart_email'] = $this->language->get('text_cart_email');
		$this->data['text_cart_passw'] = $this->language->get('text_cart_passw');
		$this->data['text_cart_passwrem'] = $this->language->get('text_cart_passwrem');
		$this->data['text_cart_login'] = $this->language->get('text_cart_login');
		
		$this->data['text_cart_telworn'] = $this->language->get('text_cart_telworn');
		$this->data['text_cart_worning'] = $this->language->get('text_cart_worning');
		$this->data['text_cart_mailworn'] = $this->language->get('text_cart_mailworn');
        ...
        if (isset($this->session->data['delivery_payment'])) {
            $this->data['delivery_calculated'] = 1;
        } else {
            $this->data['delivery_calculated'] = 0;
        }
...
//            $this->error = true;          ------------------------------------------ SNJAT dlja BEZ REGISTRACII ---------------------------------------
        }
    ...
    private function save_customer_data() {
        ...
        $GLOBALS["$pass23"] = $customer['password'];
                ...
                if ($data['email'] == '') {
                //    $this->simple->add_error('customer');             ------------------------------------------ SNJAT dlja BEZ REGISTRACII ---------------------------------------
                //    $this->error = true;                              ------------------------------------------ SNJAT dlja BEZ REGISTRACII ---------------------------------------
                    return;
                }
