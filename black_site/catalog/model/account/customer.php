...
class ModelAccountCustomer extends Model {
	...
	$message = "<div style=\"text-align:center;\">" . "  ";
		$message .= "<img src=\"http://" . $_SERVER['HTTP_HOST'] . "/image/data/images/logo.jpg\" alt=\"" . $_SERVER['HTTP_HOST'] . "\" draggable=\"false\" />" . "<br>  ";
		$message .= sprintf($this->language->get('text_welcome'), $this->config->get('config_name')) . "<br><br>";

		$this->language->load('mail/forgotten');
		
		$password3 = $GLOBALS["$pass23"];
		...
		$message .= $this->url->link('account/login', '', 'SSL') . "<br><br>";
		 $message .= "<center><div style=\"border: 1px solid #75ab15;border-radius: 15px;background: #ECFDDE;padding:10px;width: 290px;\">" . "  ";
		  $message .= $this->language->get('text_mail') . "  <b>";
		  $message .= $data['email'] . "</b><br><br>";
		  $message .= $this->language->get('text_password2') . "  <b>";
		  $message .= $password3 . "</b>";
		 $message .= "</div></center>" . "<br><br>";
