...
function simplecheckout_reload(from) {
	...
	if ( document.getElementById('with_uri').checked != true && document.getElementById('checkout_customer_main_email')) {
    ...
    jQuery.ajax({
        ...
        success: function(data) {
            ...
            if ($.cookie('type') == 'customer1') {
                document.getElementById('without').checked = true;
            }

            if ($.cookie('type') == 'customer2') {
                document.getElementById('with_fiz').checked = true;
            }

            if ($.cookie('type') == 'customer3') {
                document.getElementById('with_uri').checked = true;
            }

		if (document.getElementById('with_uri').checked == true) {
			if (document.getElementById('pay_method')) {document.getElementById('pay_method').classList.add("hideblock");}
			if (document.getElementById('labemail')) {document.getElementById('labemail').classList.add("hideblock");}
			//if (document.getElementById('field3')) {document.getElementById('field3').classList.add("hideblock");}
			if (document.getElementById('field8')) {document.getElementById('field8').classList.add("hideblock");}
		} else {
			if (document.getElementById('pay_method')) {document.getElementById('pay_method').classList.remove("hideblock");}
			if (document.getElementById('labemail')) {document.getElementById('labemail').classList.remove("hideblock");}
			//if (document.getElementById('field3')) {document.getElementById('field3').classList.remove("hideblock");}
			if (document.getElementById('field8')) {document.getElementById('field8').classList.remove("hideblock");}
		}
