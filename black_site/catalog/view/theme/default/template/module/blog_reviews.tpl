...
<div class="box box_reviews_<?php echo $position; ?>" style="display: block">
  		...
  		<div class="blog-record-list-small">
			<div id="pagewrap">
				<div class="wrapper grid4">
    				...
    				<article class="col col_reviews_<?php echo $position; ?>">
...
var toone_<?php echo $position; ?> = function()
{	rwidth_<?php echo $position; ?> = $('.box_reviews_<?php echo $position; ?>').width();
	if  (rwidth_<?php echo $position; ?> < 300) {
	$('.col:.col_reviews_<?php echo $position; ?>').addClass('col100');
	}
}
	$(window).resize(function() {
	  toone_<?php echo $position; ?>();
	});
