...
<script type="text/javascript">
	...
	function comment_reply(cid) {
     ...
     $('#comment_work_'+cid).find('#form_work_0').attr('id', 'form_work_'+cid);
...
<?php } ?>
<br>
  <div style="color: #555; font-size: 11px; margin-bottom: 5px;"><?php echo $comment['date_added']; ?></div>
...
<div style="display: inline; float: right;"><?php  echo $entry_sorting; ?>
