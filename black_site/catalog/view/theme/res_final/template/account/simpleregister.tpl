...
<div class="simple-content">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="account_form" id="simpleregister">
        <div class="simpleregister">
            ...
            ?>
                ...
                <table class="simplecheckout-customer" style="width: 50%;">
                    ...
                    <?php if ($simple_registration_subscribe == 2) { ?>
                        <tr>
                          ...
                          <td class="simplecheckout-customer-right">
                            <label><input type="radio" name="subscribe" value="1" <?php if ($subscribe) { ?>checked="checked"<?php } ?> /> <?php echo $text_yes; ?></label><br />
        ...
        <div class="simpleregister-button-block buttons">
            <div class="simpleregister-button-right">
                <?php if ($simple_registration_agreement_checkbox) { ?><label><input type="checkbox" name="agree" value="1" <?php if ($agree == 1) { ?>checked="checked"<?php } ?> /><?php echo $text_agree; ?></label>&nbsp;<?php } ?><a href="javascript:;" onclick="$('#simple_create_account').val(1);$('#simpleregister').submit();" class="button-link"><span><?php echo $text_simpreg_reg; ?></span></a>
            </div>
        </div>
    </form>
</div>
