<div class="simplecheckout-block-heading" style="display:none;"><?php echo $text_checkout_shipping_method ?></div>
<?php if ($simple_show_errors && $error_warning) { ?>
    <div class="simplecheckout-warning-block"><?php echo $error_warning ?></div>
<?php } ?> 
<div class="simplecheckout-block-content" style="display:none;">
...
<script type="text/javascript">
  $('.simplecheckout-methods-table input:radio').attr('checked','checked');
</script>
